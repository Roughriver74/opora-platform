...
import { ContactImportResult, ContactService } from '../../../../services/contactService'
...
export const ContactImportDialog: React.FC<ContactImportDialogProps> = ({
	...
	return (
		<Dialog open={open} onClose={handleClose} maxWidth='sm' fullWidth>
			<DialogTitle>Импорт контактов из Excel</DialogTitle>
			...
			<DialogContent>
				...
				{!result && (
					<Box
						...
						onClick={() => document.getElementById('contact-import-file-input')?.click()}
					>
						<input
							id='contact-import-file-input'
							type='file'
							accept='.xlsx,.xls'
				...
				{!result && (
					<Alert severity='info' sx={{ mt: 2 }}>
						<Typography variant='body2' gutterBottom>
							...
							Колонки: Фамилия*, Имя*, Отчество, Телефон, Email, Должность, Компания (ИНН или ID)* и др.
						</Typography>
						<Button
							size='small'
