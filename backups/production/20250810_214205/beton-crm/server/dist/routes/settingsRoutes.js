...
router.put('/:key', adminMiddleware_1.adminMiddleware, settingsController.updateSetting);
router.delete('/:key', adminMiddleware_1.adminMiddleware, settingsController.deleteSetting);
