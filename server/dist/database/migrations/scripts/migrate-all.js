...
const export_from_mongodb_1 = __importDefault(require("./export-from-mongodb"));
const transform_data_1 = __importDefault(require("./transform-data"));
const import_to_postgresql_1 = __importDefault(require("./import-to-postgresql"));
...
class MigrationOrchestrator {
    ...
    async exportFromMongoDB() {
        ...
        const exporter = new export_from_mongodb_1.default();
    ...
    async transformData(exportDir) {
        ...
        const transformer = new transform_data_1.default(exportDir);
    ...
    async importToPostgreSQL(transformDir) {
        ...
        const importer = new import_to_postgresql_1.default(transformDir);
...
exports.default = MigrationOrchestrator;
