...
class OptimizedSubmissionService {
    ...
    async getSubmissions(filters = {}, pagination) {
        ...
        const total = await Submission_1.default.countDocuments(query);
    ...
    async getSubmissionStats(filters = {}) {
        ...
        const stats = await Submission_1.default.aggregate([
            { $match: matchStage },
            {
                $group: {
                    _id: null,
